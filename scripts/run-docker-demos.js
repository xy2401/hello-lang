...
const demoConfigs = [
  ...
  { lang: 'c', image: 'gcc:13', file: 'cpp/dsa/linear/stack.c' },
  { lang: 'cpp', image: 'gcc:13', file: 'cpp/dsa/linear/queue.cpp' },
  ...
  { lang: 'cpp', image: 'gcc:13', file: 'cpp/dsa/graphs/union_find.cpp' },
  ...
  { lang: 'java', image: 'eclipse-temurin:21-jdk-alpine', file: 'java/dsa/linear/LinkedListDemo.java' },
  { lang: 'java', image: 'eclipse-temurin:21-jdk-alpine', file: 'java/dsa/trees/HeapDemo.java' },
  { lang: 'java', image: 'eclipse-temurin:21-jdk-alpine', file: 'java/dsa/trees/BstDemo.java' },
  { lang: 'java', image: 'eclipse-temurin:21-jdk-alpine', file: 'java/dsa/graphs/BfsDemo.java' },
  { lang: 'java', image: 'eclipse-temurin:21-jdk-alpine', file: 'java/dsa/sorting/QuickSortDemo.java' },
  { lang: 'java', image: 'eclipse-temurin:21-jdk-alpine', file: 'java/dsa/search/BinarySearchDemo.java' },
...
const catalogEvidence = [
  ...
  { id: 'css', image: pinImage('node:22-bookworm-slim'), runtime: pinImage('nginx:1.28-alpine'), web: ['css', 'demos/css/basic_demo.css'] },
  {
    ...
    sources: [
      'demos/lisp/common_lisp_demo.lisp.out.txt',
      'demos/lisp/scheme_demo.scm.out.txt',
      'demos/lisp/clojure_demo.clj.out.txt',
      'demos/lisp/racket_demo.rkt.out.txt',
    ],
